...
public class StudentController {
    ...
    public ModelAndView searchStudent(Student student, String type,
        ...
        List<StudentCustom> students = studentService.getStudentList(student);
    ...
    public ModelAndView updateStudent(@RequestParam(value = "sno", defaultValue = "-1") Integer sno) {
        ModelAndView modelAndView = new ModelAndView();
        UpdateStudentVo updateCourseVo = null;
        List<Class> classes = classService.getAllClass(new Class());
        if (sno != -1) {
            //先找到这个学生的信息
            StudentCustom student = studentService.getStudentByNo(sno);
            updateCourseVo = new UpdateStudentVo(student, classes);
            modelAndView.addObject("student", updateCourseVo);
        }else {
            updateCourseVo = new UpdateStudentVo(null, classes);
            modelAndView.addObject("student", updateCourseVo);
        }
    ...
    public @ResponseBody
    Student queryStudent(Integer sno) {
    ...
    public ModelAndView studentInfo(HttpSession httpSession) {
        ...
        StudentCustom student = studentService.getStudentByNo(Integer.parseInt(username));
    ...
    public ModelAndView updateStudentInfoPage(String sno) {
        ...
        List<Class> classes = classService.getAllClass(new Class());
        //先找到这个学生的信息
        StudentCustom student = studentService.getStudentByNo(Integer.parseInt(sno));
        updateCourseVo = new UpdateStudentVo(student, classes);
        modelAndView.addObject("student", updateCourseVo);
    ...
    public @ResponseBody
    String changePassword(HttpSession httpSession, String oldPassword, String newPassword) {
        String username = (String) httpSession.getAttribute("username");
